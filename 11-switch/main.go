...
func main() {
	...
	case num >= 50 && num < 100:
		println("Num is betwee range of 50-100")
	...
	char := 'A'
	switch char {
	case 65, 69, 73, 79, 85: //Can check unicode for rune in switch statement also
		println(string(char), "is a upper case vowel")
	case 'a', 'e', 'i', 'o', 'u':
		println(string(char), "is a lower case vowel")
	default:
		println(string(char), "is either a consonant or special character")
	}
